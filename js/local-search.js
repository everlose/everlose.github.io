    ...
    fetch(path)
      ...
      .then(res => {
        ...
        datas = isXml ? [...new DOMParser().parseFromString(res, 'text/xml').querySelectorAll('entry')].map(element => {
          return {
            title  : element.querySelector('title') ? element.querySelector('title').innerHTML : '',
            content: element.querySelector('content') ? element.querySelector('content').innerHTML : '',
            url    : element.querySelector('url') ? element.querySelector('url').innerHTML : ''
          };
        }) : JSON.parse(res);
